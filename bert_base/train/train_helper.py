...
def get_args_parser():
    ...
    if os.name == 'nt':
        ...
        bert_path = '/home/wanglei/algorithm/github/bert-bilstm-crf-ner/bert_base/chinese_L-12_H-768_A-12'
        root_path = '/home/wanglei/algorithm/github/bert-bilstm-crf-ner'
    ...
    # 预训练bert模型的目录
    group1.add_argument('-output_dir', type=str, default=os.path.join(root_path, 'outputs'),
                        help='directory of a pretrained BERT model')
    # 初始检查点(通常来自预先训练的BERT模型)。
    ...
    group2.add_argument('-clip', type=float, default=0.5,
                        help='Gradient clip')
    # 训练的比例以线性的学习速率进行热身。 例如，0.1 =培训的10%。
